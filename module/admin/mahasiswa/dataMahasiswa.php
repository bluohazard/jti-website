                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-6">
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-10">
                                                                            <input type="text" class="form-control" placeholder="Username" id="usernameMahasiswaAdmin" name="usernameMahasiswaAdmin" required />
                                                                        </div>
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-10">
                                                                            <input type="password" class="form-control" placeholder="**********" name="passwordMahasiswaAdmin" id="passwordMahasiswaAdmin" required />
                                                                        </div>
                                                                        <div class="col-sm-3"></div>
                                                                        <div class="col-sm-9">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="input-group col-sm-10">
                                                                            <img src="../attachment/img/avatar.jpeg" id="fotoPrevMahasiswaAdmin3" height="150px" width="150px">
                                                                        </div>
                                                                ...
                                                                <div class="col-sm-6">
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-10">
                                                                            <input type="text" class="form-control" placeholder="NIM Mahasiswa" id="nimMahasiswaAdmin" name="nimMahasiswaAdmin" required />
                                                                        </div>
                                                                        <div class="col-sm-3"></div>
                                                                        <div class="col-sm-9">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-10">
                                                                            <input type="text" class="form-control" placeholder="Nama Mahasiswa" id="namaMahasiswaAdmin" name="namaMahasiswaAdmin" required />
                                                                        </div>
                                                                        <div class="col-sm-3"></div>
                                                                        <div class="col-sm-9">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-10">
                                                                            <input type="text" class="form-control" placeholder="Tempat Lahir Mahasiswa" id="tempatlahirMahasiswaAdmin" name="tempatlahirMahasiswaAdmin" required />
                                                                        </div>
                                                                        <div class="col-sm-3"></div>
                                                                        <div class="col-sm-9">
                                                                        ...
                                                                        <div class="col-sm-10">
                                                                            <div class="form-check form-check-inline">
                                                                                <label class="form-check-label" for="genderMahasiswaAdmin1">
                                                                                    <input class="mt-2" type="radio" name="genderMahasiswaAdmin" id="genderMahasiswaAdmin1" value="Laki-laki" checked>
                                                                                    Laki-laki
                                                                                </label>
                                                                            </div>
                                                                            <div class="form-check form-check-inline">
                                                                                <label class="form-check-label" for="genderMahasiswaAdmin2">
                                                                                    <input class="mt-2" type="radio" name="genderMahasiswaAdmin" id="genderMahasiswaAdmin2" value="Perempuan">
                                                                                    Perempuan
                                                                                </label>
                                                                            </div>
                                                                        </div>
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-10">
                                                                            <textarea class="form-control" id="alamatMahasiswaAdmin" name="alamatMahasiswaAdmin" rows="3" placeholder="Alamat Mahasiswa" required></textarea>
                                                                        </div>
                                                                        <div class="col-sm-3"></div>
                                                                        <div class="col-sm-9">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-10">
                                                                            ...
                                                                            ?>
                                                                            <select name="prodiMahasiswa" class="custom-select" style="width:220px;">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    <tr id="<?php echo $row["id_mahasiswa"] ?>" class="itemDataMahasiswa">
                                                        ...
                                                        <td class="kodeKelasMahasiswa "><?php echo $row["kode"]; ?>-<?php echo $row["tingkat"];
                                                                                                                    echo $row["kode_kelas"] ?></td>

                                                        <td>
                                                            <a id_userEdit="<?php echo $row["id_user"]; ?>" id_mahasiswaEdit="<?php echo $row["id_mahasiswa"]; ?>" class='btn btn-primary btn-edit edit-mahasiswa-admin text-white' data-toggle='modal' data-target='#modalEditAdminMahasiswa'>Edit</a>

                                                        </td>
                                                        <td>
                                                            <a id_user="<?php echo $row["id_user"]; ?>" id_mahasiswa="<?php echo $row["id_mahasiswa"]; ?>" class='btn btn-danger btn-hapus hapus-mahasiswa-admin text-white' data-toggle='modal' data-target='#modalHapusDataMahasiswa'>Hapus</a>
