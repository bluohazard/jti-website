            ...
            <div class="card-body">
              <form action="../process/proses_adminBeasiswa.php?module=beasiswa&act=tambah" method="post">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-12">
                    <textarea style="border:none" name="isiBeasiswa" id="isiBeasiswa" cols="30" rows="4" placeholder="Ketik Beasiswa..." maxlength="300" class="form-control border-bottom border-gray pb-2 mb-0" oninput="Beasiswacharcountupdate(this.value)"></textarea>
                  </div>
                </div>
                <div class="row">
