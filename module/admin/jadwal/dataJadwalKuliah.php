                    ...
                    <div class="media-body pb-3 mb-0 small lh-125">
                        <div class="isi">
                            <div class="card border border-secondary">
                                ...
                                <div class="card-body">
                                    <div class="col-md-12 p-0">
                                        <form action="../process/proses_adminJadwalKuliah.php?module=dataJadwalKuliah&act=tambah" method="POST">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <select class="semester custom-select" id="id_kelas" name="id_kelas" required>
                                                                    ...
                                                                    ?>
                                                                            <option value="<?php echo $rowKelas["id_kelas"]; ?>">
                                                                                <?php echo $rowKelas["kode"]; ?>-<?php echo $rowKelas["tingkat"];
                                                                                                                    echo $rowKelas["kode_kelas"]; ?>
                                                                            </option>
                                                                    <?php
                                                                        }
                                                                    }
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <select class="semester custom-select" id="hari" name="hari" required>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-5">
                                                                <select class="semester custom-select" id="jam_mulai" name="jam_mulai" required>
                                                            ...
                                                            <div class="col-sm-4">
                                                                <select class="semester custom-select" id="jam_selesai" name="jam_selesai" required>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <select class="semester custom-select" id="id_semester" name="id_semester" required>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <select class="semester custom-select" id="id_matkul" name="id_matkul" required>
                                                                    ...
                                                                    ?>
                                                                            <option value="<?php echo $rowMatkul["id_matkul"]; ?>">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <select class="semester custom-select" id="id_ruang" name="id_ruang" required>
                                                        ...
                                                        <div class="form-group row">
                                                            <label class="col-sm-2 col-form-label">Dosen
                                                                Pengajar</label>
                                                            <div class="col-sm-10">
                                                                <select class="semester custom-select" id="id_dosen" name="id_dosen" required>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr class="itemJadwalKuliah">
                                                    <td class="tampil-detail" data-kelas="<?php echo $row["id_kelas"]; ?>" data-semester="<?php echo $row["id_semester"]; ?>"><?php echo $no; ?></td>
                                                    <td class="tampil-detail kelas" data-kelas="<?php echo $row["id_kelas"]; ?>" data-semester="<?php echo $row["id_semester"]; ?>">
                                                        <?php echo $row["kode"]; ?>-<?php echo $row["tingkat"];
                                                                                    echo $row["kode_kelas"] ?>
                                                    </td>
                                                    <td class="tampil-detail nama" data-kelas="<?php echo $row["id_kelas"]; ?>" data-semester="<?php echo $row["id_semester"]; ?>">
                                                        <?php echo $row["nama"]; ?></td>
                                                    <td class="tampil-detail semester" data-kelas="<?php echo $row["id_kelas"]; ?>" data-semester="<?php echo $row["id_semester"]; ?>">
                                                        <?php echo $row["semester"]; ?></td>
                                                    <td class="tampil-detail jumlah_matkul" data-kelas="<?php echo $row["id_kelas"]; ?>" data-semester="<?php echo $row["id_semester"]; ?>">
                                                        <?php echo $row["jumlah_matkul"]; ?></td>
                                                    <td class="tampil-detail jumlah_sks" data-kelas="<?php echo $row["id_kelas"]; ?>" data-semester="<?php echo $row["id_semester"]; ?>">
                                                        <?php echo $row["jumlah_sks"]; ?></td>
                                                    <td><button class="btn btn-primary edit-jadwal-kuliah" data-kelas="<?php echo $row["id_kelas"]; ?>" data-semester="<?php echo $row["id_semester"]; ?>" type="button" class="pratinjau btn" data-toggle="modal" data-target="#editModal">Edit</button></td>
                                                    <td><button class="btn btn-danger hapus-jadwal-kuliah" id="<?php echo $row["id_kelas"]; ?>" attrSemester="<?php echo $row["id_semester"]; ?>" type="button" data-toggle="modal" data-target="#hapus">Hapus</button></td>
                                                </tr>
                                        <?php
                                                $no++;
                                            }
        ...
        <div class="modal fade" id="hapus" tabindex="-1" role="dialog" aria-labelledby="hapus" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content konten-modal">
                    <form action="../process/proses_adminJadwalKuliah.php?module=dataJadwalKuliah&act=hapus" method="POST">
