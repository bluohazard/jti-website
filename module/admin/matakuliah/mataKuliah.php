...
<main role="main" class="container-fluid" id="ruang">
  <div class="row">
            ...
            <div class="row pt-2 mt-2 pl-0 scrollbar" id="ruangan2">
              ...
              ?>
                ...
                <div class='col-md-12 p-2 text-center'>
                  <p class='text-muted'>Data Mata Kuliah Kosong</p>
                </div>
              <?php
              }
              ?>

              <div class='col-md-12 p-2 text-center' id='matkulTidakDitemukan' style="display:none;">
                <p class='text-muted'>Mata kuliah tidak dapat ditemukan</p>
              </div>
            </div>
          </div>
        </div>
    ...
    <!-- Modal Hapus Ruangan-->
    <div class="modal fade" id="modalHapusMatakuliah" tabindex="-1" role="dialog" aria-labelledby="modalHapusMatakuliah" aria-hidden="true">
