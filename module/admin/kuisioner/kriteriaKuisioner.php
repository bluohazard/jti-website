...
<main role="main" class="container-fluid" id="kuisioner">
  <div class="row">
    ...
    <div class="col-md-12 p-0">
      <div class="m-2 p-3 bg-white mb-3 rounded shadow-sm">
        <div class="container-fluid p-0">
          ...
          <!-- Modal Edit Kriteria-->
          <div class="modal modalEditKriteria fade" id="modalEditKriteria" tabindex="-1" role="dialog" aria-labelledby="modalEditKriteria" aria-hidden="true">
    ...
    <div class="modal fade" id="modalHapusKriteria" tabindex="-1" role="dialog" aria-labelledby="modalHapusKriteria" aria-hidden="true">
  ...
  <div class="modal fade" id="modalTambahKriteria" tabindex="-1" role="dialog" aria-labelledby="modalTambahKriteria" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
