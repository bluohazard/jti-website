...
<main role="main" class="container-fluid" id="kuisioner">
  <div class="row">
        ...
        <div class="container-fluid p-0">
          <div class="row">
            <div class="col-md-6 ">
              ...
              <div class="modal fade" id="modalLihatperKelas" tabindex="-1" role="dialog" aria-labelledby="modalLihatperKelas" aria-hidden="true">
              ...
              <?php } else if (cekStatusAktif($con) == false) { ?>
    ...
    <!-- Modal Lihat Hasil-->
    <div class="modal modalLihatHasil fade" id="modalLihatHasil" tabindex="-1" role="dialog" aria-labelledby="modalLihatHasil" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
          <div class="modal-body">
            <button type="button" class="close close-setting" data-dismiss="modal" aria-label="Close">
            ...
            <div class="container-fluid">
              <div class="row mt-2">
                ...
                <input type="button" value="Cari" name="cariKuisionerDosen" id="cariKuisionerDosen" class="btn btn-success button">
              </div>
