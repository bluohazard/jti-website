...
<main role="main" class="container-fluid" id="ruang">
  <div class="row">
      ...
      <div class="m-2 p-3 bg-white rounded shadow-sm">
        ...
        <div class="pt-3">
          <div class="container-fluid p-0">
            ...
            <div class='col-md-12 p-2 text-center mt-3' id='pemesananTidakDitemukan' style="display:none;">
    ...
    <div class="col-md-6 p-0">
        ...
        <div class="m-2 p-3 bg-white mb-3 rounded shadow-sm">
          ...
          <div class="pt-3">
            <div class="container-fluid">
              ...
              <div class="row pt-2 mt-2 pl-0 scrollbar scrollbar-x" id="ruangan2">
                ...
                ?>
                  ...
                  <div class='col-md-12 p-2 text-center'>
                    <p class='text-muted'>Data Ruang Kosong</p>
                  </div>
                <?php
                }
                ?>
              ...
              <div class='col-md-12 p-2 text-center' id='ruanganTidakDitemukan' style="display:none;">
      ...
      <!-- Modal Hapus Ruangan-->
      <div class="modal fade" id="modalHapusRuangan" tabindex="-1" role="dialog" aria-labelledby="modalHapusRuangan" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
